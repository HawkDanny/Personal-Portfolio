...
var proColor = (function() {
    ...
    //returns a random color from the range of the given enum with the lightness set to min, already formatted properly
    //colorRangeVal a ColorRange enum value
    ...
    //returns a random color from the range of the given enum with the lightness set to max, already formatted properly
    //colorRangeVal a ColorRange enum value
