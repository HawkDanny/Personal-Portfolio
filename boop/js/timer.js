...
app.Timer = function(){
    ...
    function Timer(ctx, timeLimit, x, y, startingColor, endingColor) {
        this.ctx = ctx;
        ...
        if (startingColor.h < endingColor.h) {
            this.colorStep.h = (endingColor.h - startingColor.h) / this.timeLimit;
            this.colorDireciton.h = 1;
        } else {
            this.colorDireciton.h = -1;
            this.colorStep.h = (startingColor.h - endingColor.h) / this.timeLimit;
        }
        if (startingColor.s < endingColor.s) {
            this.colorStep.s = (endingColor.s - startingColor.s) / this.timeLimit;
            this.colorDireciton.s = 1;
        } else {
            this.colorDireciton.s = -1;
            this.colorStep.s = (startingColor.s - endingColor.s) / this.timeLimit;
        }
        if (startingColor.l < endingColor.l) {
            this.colorStep.l = (endingColor.l - startingColor.l) / this.timeLimit;
            this.colorDireciton.l = 1;
        } else {
            this.colorDireciton.l = -1;
            this.colorStep.l = (startingColor.l - endingColor.l) / this.timeLimit;
        }
    }
