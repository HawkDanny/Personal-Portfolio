...
window.onload = function() {
    ...
    //resize the canvas to be the width and height of the screen
    resize = new app.Resize(canvas);
    resize.resizeWidth();
    resize.resizeHeight();

    //create the fractal background
    background = new app.Fractal(canvas, ctx);
...
function draw(event) {
    ...
    //Draw my name for desktop
    if (canvas.width > 730) {
        ctx.textAlign = "center";

        ctx.font = "bold 72pt Open Sans, sans-serif";
        ctx.textBaseline = "bottom";
        ctx.fillStyle = "#080808";
        ctx.fillText("DANNY HAWK", canvas.width / 2, canvas.height / 2);
        ...
        ctx.font = "bold 36pt Open Sans, sans-serif";
        ctx.textBaseline = "bottom";
        ctx.fillStyle = "#080808";
        ctx.fillText("DANNY HAWK", canvas.width / 2, canvas.height / 2);
